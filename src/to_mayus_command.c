...
/**
* @fn static void toMayus_Task(void *params)
* @brief Tarea de ejecucion del procesador del comando "To Mayus"
* @return Nada
* @note Tarea de FreeRTOS
*/
static void toMayus_Task(void *params) {
...
bool_t toMayusCommand_init(void) {
   ...
   if (pdPASS != xTaskCreate(toMayus_Task,                        // Task Function
                             "toMayus_Task",                      // Task Name as string for user
